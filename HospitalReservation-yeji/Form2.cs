    ...
    public partial class Form2 : Form
    {
        ...
        private void dgvReservation_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                ...
                if (row.Cells["PATIENT_NAME"].Value != null)
                {
                    txtPatientName.Text = row.Cells["PATIENT_NAME"].Value.ToString();
                }
                ...
                if (row.Cells["DEPT"].Value != null)
                {
                    cboDept.SelectedValue = row.Cells["DEPT"].Value.ToString();
                }

                if (row.Cells["DOCTOR_ID"].Value != null)
                {
